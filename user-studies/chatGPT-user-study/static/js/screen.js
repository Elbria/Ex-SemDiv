                ...
                <div class="row">\
                    <div class="col-md-12">\
                        <div style="margin-top:20px;">\
                           <strong> Do the above excerpts contain some differences in meaning? </strong>\
                        </div>\
                       ...
                       <br>\
                        ...
                        <div class="form-group">\
                            <label for="class'+i+'">Choose the type that best describes the meaning difference.</label>\
                            <select class="form-control" name="class'+i+'">\
                              <option>N/A</option>\
                              <option>Added (in '+language+')</option>\
                              <option>Added (in English)</option>\
        ...
        '<div class="panel panel-danger">\
            <div class="panel-heading">\
                ...
                <div class="row">\
                     <div class="col-md-5" >\
                        <div class="form-group">\
                            <label for="atncheck1">What was your response to the previous request: Choose the type that best described the meaning difference.</label>\
...
function agreement_atncheck(i, notes){
    $(
        '<div class="panel panel-danger">\
            ...
            <div class="task">\
                <div>What was your answer to the previous question: Do the above excerpts contain some differences in meaning?</div>\
                <div  style="margin-left:40px; margin-top:10px;">\
