function agg_screen(i, notes){
    ...
    highlight_question = '<div style="margin-top:10px;margin-bottom:20px">\
            <p>The highlights were useful. I feel that highlights helped in determining whether the compared excerpts contained some meaning differences.</p>\
        ...
        likeToUse_question = '<div style="margin-top:10px;margin-bottom:20px">\
            <p>I would like to use the AI generated highlights for helping me detect meaning differences.</p>\
            <div style="margin-left:40px; marign-top:10px">\
