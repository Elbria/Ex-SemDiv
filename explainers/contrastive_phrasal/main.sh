output_dir=/fs/clip-divergences/xling-SemDiv/Ex-SemDiv/outputs
input_dir=/fs/clip-divergences/xling-SemDiv/Ex-SemDiv/annotations
#model=/fs/clip-divergences/xling-SemDiv/trained_bert_new/from_WikiMatrix.en-es.tsv.filtered_sample_50000.moses.seed/contrastive_divergence_ranking/rdpg
