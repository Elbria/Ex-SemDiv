...
class DivergentmBERTScorer:
    ...
    def __init__(
        ...
        config = config_class.from_pretrained(model_path, num_labels=num_labels, finetuning_task=task_name, output_hidden_states=True, output_attentions=True)
    ...
    def compute_divergentscore(self, texts_a, texts_b):
        ...
        #examples = _create_examples(texts_a, texts_b)
